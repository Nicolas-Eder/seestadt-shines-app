...
rasterizeVotes(votes, negativeVotes);
let highestVoteCount = getHighestVoteCount();
let lowestVoteCount = getLowestVoteCount();
...
function isInCircle(rasterIndex, circleCenter) {
    ...
    return distance <= CIRCLE_RADIUS_PERCENT;
}
