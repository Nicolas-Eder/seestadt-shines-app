...
const CIRCLE_RADIUS_PERCENT = 5; // How much of the width of the map is the circle radius?
...
createRaster();
visualizeRaster(raster.flat(),{x:RASTER_UNITS/100, y:RASTER_UNITS/100}, null);
